...
* [High Performance Browser Networking](https://hpbn.co/) - Очень хорошая книга для изучения компьютерных сетей. Написана в 2013 году, но большинство разделов до сих пор являются актуальными и полезными для начинающих.В книге можно найти информацию по особенностям протоколов HTTP/1.1 и HTTP/2, оптимизации их производительности, информацию по базовому устройству компьютерных сетей, включая протоколы TCP, UDP, TLS, так и особенности производительности сетевого взаимодействия в зависимости от типа сети (Wi-Fi, мобильные сети).
* [Computer Networks: A Systems Approach [2026]](https://7e.systemsapproach.org/index.html) - книга посвящена принципам построения сетей и работе с сетевыми технологиями. Благодаря этой книге вы можете изучить ключевые концепции и принципы построения сетей, а также разберете ряд примеров современных технологий и сервисов. Например, как работают крупнейшие площадки вроде Spotify и Netflix.
* [IPv6 book [2026]](https://github.com/becarpenter/book6/) - практическое введение в IPv6 для технических специалистов, которое поддерживается в актуальном состоянии.
...
* [Основы сетевых технологий](https://mws.ru/courses/network-technologies) - бесплатный образовательный курс, который поможет научиться выявлять и устранять проблемы в сетях, понять, как данные перемещаются по сети и что такое маршрутизация, познакомиться с принципами работы сетей и их основными компонентами, разобраться с вопросами безопасности в сетевых технологиях и научиться защищать свои данные и узнать о различном сетевом оборудовании и современных технологиях, которые его сопровождают.
* [Компьютерные сети, Климанов М. М.](https://www.youtube.com/playlist?list=PLthfp5exSWErPFK_-EAhVtxO3XoY0gsSe) - бесплатный курс, который содержит все необходимые темы по компьютерным сетям. 7 лекций по 2 часа каждая.
...
* [Network is reachable.](https://www.youtube.com/@Networkisreachable/playlists) - Канал Уржумцева Дмитрия. Полезные лекции и уроки по основам сетей, которые сопровождаются демонстрацией практических примеров настройки Cisco, Huawei, Juniper и решения задач из сертифицированных экзаменов.
...
* [@iscode](https://t.me/iscode) - множетсво полезных публикаций о сетях в доступной форме!
...
* [@eztoolsbot](https://t.me/eztoolsbot) - централизованный бот, который поможет получить необходимую информацию не выходя из Telegram: Калькулятор и поиск IP, сканер портов, поиск вендоров, проверка SSL, поиск DNS и многое другое... 
