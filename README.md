...
* [IPv6 book](https://github.com/becarpenter/book6/) - практическое введение в IPv6 для технических специалистов, которое поддерживается в актуальном состоянии.
...
* [Сети в Linux](https://seteviki.nuzhny.net) - Получите опыт сетевого администрирования на Linux, который можно адаптировать для работы в любой компании и в любом проекте. 30% теории и 70% практики, домашние задания с ревью. В качестве выпускной работы тебе нужно будет собрать или «‎починить»‎ виртуальную лабораторию.
